...
setup(
    ...
    license='MIT',
    entry_points={"console_scripts": ["musicbot = musicbot.main:main"]},
    ...
    extras_require={"dev": ["bump2version==1.*,>=1.0.0", "coverage-badge==1.*,>=1.0.0", "dephell==0.*,>=0.8.3", "flake8==3.*,>=3.8.3", "html5lib==1.*,>=1.0.1", "mypy==0.*,>=0.782.0", "pygments==2.*,>=2.7.0", "pylint==2.*,>=2.6.0", "pytest-cov==2.*,>=2.6.0", "pytest-docker-compose==3.*,>=3.1.2", "pytype==2020.*,>=2020.8.28", "restructuredtext-lint==1.*,>=1.3.0"]},
)
