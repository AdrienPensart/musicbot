...
setup(
    ...
    install_requires=['attrdict==2.*,>=2.0.0', 'attrs==19.*,>=19.1.0', 'cached-property==1.*,>=1.5.1', 'click==7.*,>=7.0.0', 'click-aliases==1.*,>=1.0.1', 'click-completion==0.*,>=0.5.2', 'click-didyoumean==0.*,>=0.0.3', 'click-man==0.*,>=0.4.1', 'click-spinner==0.*,>=0.1.8', 'colorama==0.*,>=0.4.3', 'coloredlogs==14.*,>=14.0.0', 'feedparser==5.*,>=5.2.1', 'flask==1.*,>=1.1.1', 'graphql-py==0.*,>=0.7.1', 'humanfriendly==8.*,>=8.1.0', 'isodate==0.*,>=0.6.0', 'isort[pyproject]==4.*,>=4.3.0', 'logging-tree==1.*,>=1.8.0', 'mps-youtube==0.*,>=0.2.8', 'mutagen==1.*,>=1.44.0', 'prettytable==0.*,>=0.7.2', 'prompt-toolkit==3.*,>=3.0.2', 'psycopg2-binary==2.*,>=2.8.0', 'pyacoustid==1.*,>=1.1.0', 'pydub==0.*,>=0.23.1', 'python-dotenv==0.*,>=0.12.0', 'python-slugify==4.*,>=4.0.0', 'python-vlc==3.*,>=3.0.0', 'spotipy==2.*,>=2.10.0', 'tqdm==4.*,>=4.31.0', 'watchdog==0.*,>=0.10.0', 'youtube-dl==2020.*,>=2020.1.24'],
