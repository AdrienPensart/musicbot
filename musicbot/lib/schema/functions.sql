...
--returns void as $$
--begin
--    refresh materialized view concurrently public.mmusics;
--    --refresh materialized view concurrently public.smusics;
--    --refresh materialized view public.unique_lexeme;
--end;
--$$ language plpgsql;
--
--create or replace function public.new_filter
--(
...
--$$
--begin
--    perform public.upsert(public.new_music(title, album, genre, artist, folder, youtube, number, path, rating, duration, size, keywords));
--end
--$$ language plpgsql;
--
--create or replace function public.do_filter(mf public.filters default public.new_filter())
--returns setof public.music as
--$$
--    select *
--    from public.mmusics mv
--    where
